...
from model_all import NoisyNetwork_Dueling_PER as NNDPNetwork
...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        # Q-Network
        self.qnetwork_local = NNDPNetwork(state_size, action_size, seed).to(device)
        self.qnetwork_target = NNDPNetwork(state_size, action_size, seed).to(device)
...
#         print("state_shape_act",state.shape)
